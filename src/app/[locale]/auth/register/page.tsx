...
const RegisterPage = () => {
  ...
  const FormSchema = z.object({
    ...
    username: z.string().min(3, {
      message: t("Validation.minLength", { field: t("Fields.username"), min: 3 }),
    }),
  });
              ...
              <form onSubmit={form.handleSubmit(onSubmit)}>
                <div className="grid gap-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <div className="grid gap-3">
                          ...
                          <FormControl>
                            <Input id="username" type="text" placeholder="johndoe" {...field} />
                          </FormControl>
                          <FormMessage />
                        </div>
                      )}
                  ...
                  <div className="text-center text-sm">
                    ...
                    <Link href={ROUTE_PATHS.AUTH.SIGN_IN} className="underline underline-offset-4">
                      Sign in
                    </Link>
                  </div>
                </div>
